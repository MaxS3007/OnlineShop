...
class ColordAdapter(val items: MutableList<String>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ColordAdapter.Viewholder {
        context = parent.context
        val binding = ViewholderColorBinding.inflate(LayoutInflater.from(context), parent, false)
        return Viewholder(binding)
    }

    override fun onBindViewHolder(holder: ColordAdapter.Viewholder, position: Int) {
